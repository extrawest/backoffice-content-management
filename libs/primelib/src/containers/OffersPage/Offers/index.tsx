	...
	return (
		<div className="border rounded-1">
			<div className="flex justify-between align-middle p-2">
				<h4 className="header-section">Offers</h4>
				<Link
			...
			<div className="flex justify-between align-middle p-2">
				<h5 className="sub-header">Create new offer</h5>
				<button
			...
			{!!offers?.length && (
				<ul>
					{offers.map((
						...
						>
							<h6 className="task-title">{offer?.title}</h6>
							<h6 className="task-title">{offer?.description}</h6>
						</li>
					))}
				</ul>
			)}
			{!offers?.length && <h4 className="sub-header p-2">No offers yet...</h4>}
			<Modal
