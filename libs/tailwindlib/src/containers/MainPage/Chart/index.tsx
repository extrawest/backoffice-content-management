		...
		<div className="section-border mb-2">
			<div className="flex">
				<div className="w-10/12 p-2">
					<h4 className="header-section mb-6">Today&apos;s trends</h4>
					<ResponsiveContainer
						width="100%"
						aspect={3}
					>
				...
				<div className="py-2 border-l border-solid border-colorBorder w-2/12">
					<ul className="w-full">
						<li className="chart-list-item">
							<h5 className="text-chart">Backlog</h5>
							<p className="text-chart-value">{backlogLength}</p>
						</li>
						<li className="chart-list-item">
							<h5 className="text-chart">Tasks in progress</h5>
							<p className="text-chart-value">{tasksLength}</p>
						</li>
						<li className="chart-list-item">
							<h5 className="text-chart">Total</h5>
							<p className="text-chart-value">{backlogLength + tasksLength}</p>
						</li>
					</ul>
				</div>
			</div>
